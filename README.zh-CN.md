...
docs-check         中英文 Markdown 配对、本地链接与视觉资源完整性
...
更完整的攻击者模型、密钥边界和失败策略见[安全模型](docs/SECURITY_MODEL.zh-CN.md)。

## 文档导航

| 文档 | 内容 |
|---|---|
| [文档中心](docs/README.zh-CN.md) | 阅读顺序、术语与文档地图 |
...
| [功能完成度](docs/FUNCTIONAL_STATUS.zh-CN.md) | 各 Renderer/Capability 的真实实现与未完成项 |
| [贡献指南](CONTRIBUTING.zh-CN.md) | 从 Issue 到 PR、自动审核与验证流程 |
